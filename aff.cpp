...
void aff::on_ajouter_pushButton_clicked()
{
...
void aff::on_suprimer_pushButton_clicked()
{


    int num_proces = ui->num_proces_supp->text().toInt();
    bool test=afff.supprimer(num_proces);
    if(test)
{
        foreach(QLineEdit* le, findChildren<QLineEdit*>()) {
                             le->clear();}
...
void aff::on_afficher_pushButton_clicked()
...
void aff::on_modiffier_pushButton_clicked()
{
...
void aff::on_chercher_pushButton_clicked()
{
    affaires c;
...
void aff::on_pdf_pushButton_clicked()
{
    QString strStream;
...
void aff::on_calendarWidget_clicked(const QDate &date)
...
void aff::on_pushButton_add_clicked_clicked()
{
...
void aff::on_stat_pushButton_clicked()
...

    {
        ...
        *set0 << aff_.statistiquesaffaire("classifier") <<aff_.statistiquesaffaire("non classifier");
...
void aff::on_tabWidget_currentChanged(int index)
{
    readfile();
}
...
void aff::on_pushButton_7_clicked()
{
    hide();
}
