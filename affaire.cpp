...
{
    QSqlQuery query;
    query.prepare("UPDATE affaire SET num_proces= :num_proces,date_proces= :date_proces,type_proces = :type_proces,nom_avocat_civiles = :nom_avocat_civiles ,nom_avocat_defense=:nom_avocat_defense,nom_juge=:nom_juge ,jury=:jury ,accuses=:accuses,greffier=:greffier ,description=:description  WHERE num_proces= :num_proces ");
