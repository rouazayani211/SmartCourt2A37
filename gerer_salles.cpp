...
gerer_salles::gerer_salles(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::gerer_salles)
{
    ui->setupUi(this);
        /////////////////////////////////////////////////////////// arduino
...
void gerer_salles::on_pushButton_ajoute_ghatas_clicked()
{
...
void gerer_salles::on_pushButton_modifier_ghatas_clicked()
{
...
void gerer_salles::on_pushButton_supprimer_ghatas_clicked()
{
    salles s;
...
void gerer_salles::on_lineEdit_recherche_ghatas_textChanged(const QString &arg1)
{
    ui->tableView_salle_ghatas->setModel(s.Recherche(arg1));
}

void gerer_salles::on_pushButton_trier_ghatas_clicked()
{
    ui->tableView_salle_ghatas->setModel(s.TriParNum());
}
void gerer_salles::on_pushButton_pdf_ghatas_clicked()
{
    QPrinter printer;
...
void gerer_salles::on_pushButton_stat_ghatas_clicked()
{
    QSqlQueryModel * model= new QSqlQueryModel();
...
void gerer_salles::write(QString action)
{
...
void gerer_salles::on_pushButton_entree_ghatas_clicked()
{
...
void gerer_salles::on_pushButton_sortie_ghatas_clicked()
{
...
void gerer_salles::on_pushButton_10_clicked()
{
    hide();
}

void gerer_salles::on_pushButton_11_clicked()
{
    hide();
}

void gerer_salles::on_pushButton_12_clicked()
{
    hide();
}
