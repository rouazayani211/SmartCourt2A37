...
void empp::on_b_modifier_clicked()
{
...
void empp::on_b_supprimer_clicked()
{
...
void empp::on_tri_nom_clicked()
{
    ui->tab_employes->setModel(emp.trieremployes());
}

void empp::on_pdf_clicked()
{
...
void empp::on_recherche_2_clicked()
{
...
void empp::on_stat_clicked()
{
    employes e;
            QBarSet *set0 = new QBarSet("statistique : courbe");

            *set0 << e.statistiquesemployes("juge") <<e.statistiquesemployes("juri")<<e.statistiquesemployes("solliciteur");
            ...
            categories << "juge" << "juri"<< "solliciteur";
...
void empp::on_stat_2_clicked()
{
    ui->SW->setCurrentIndex(0);

}

void empp::on_QR_clicked()
{
...
void empp::on_supp_clicked()
{
    ui->SW->setCurrentIndex(5);
}

void empp::on_logout_clicked()
{
hide();
}

void empp::on_return_2_clicked()
{
    ui->SW->setCurrentIndex(2);
}

void empp::on_return_3_clicked()
{
    ui->SW->setCurrentIndex(2);
}

void empp::on_b_modifier_2_clicked()
{
    ui->SW->setCurrentIndex(6);
}

void empp::on_afficher_clicked()
{
    ui->SW->setCurrentIndex(3);
}

void empp::on_return_4_clicked()
{
    ui->SW->setCurrentIndex(2);
}

void empp::on_return_5_clicked()
{
    ui->SW->setCurrentIndex(2);
}

void empp::on_ajouter_2_clicked()
{
    ui->SW->setCurrentIndex(7);
}

void empp::on_map_clicked()
{
    ui->SW->setCurrentIndex(1);

}

void empp::on_return_6_clicked()
{
    ui->SW->setCurrentIndex(2);
...
void empp::on_pointage_clicked()
{
  ui->SW->setCurrentIndex(4);
}

void empp::on_return_7_clicked()
{
   ui->SW->setCurrentIndex(2);
}

void empp::on_pushButton_9_clicked()
{
    hide();
}
